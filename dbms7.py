...
class main:
    ...
    def cur(self):
        ...
        self.photo9=PhotoImage(file="")
        self.canvas8.create_image(0,0,image=self.photo9,anchor=NW)
        
        self.develop=Label(self.fm3,text='Made by Aryan,Janisha Sharma,Kush Gautam',bg='#fff',fg='#d7837f',font=('Candara',12,'bold'))
        self.develop.place(x=580,y=350)
    ...
    def addbook(self):
        class temp(main):
            def book(self):
                ...
                self.log = PhotoImage(file=r'E:\downloads\back.png')
                self.backbt.config(image=self.log, compound=LEFT)
                self.small_log = self.log.subsample(4, 4)
    ...
    def issuebook(self):
        class test(main):
            ...
            def issue(self):
                ...
                self.log = PhotoImage(file=r'E:\downloads\back.png')
                self.small_log = self.log.subsample(4, 4)  # Adjust the subsample factor as needed
                self.backbt = Button(self.fc, width=60, bg='#ffe8ec', activebackground='#ffe8ec', bd=0, relief='flat', command=self.cur)
                self.backbt.place(x=0, y=0)
                self.backbt.config(image=self.small_log, compound=LEFT)
            ...
            def data(self):
                ...
                self.var=cursor.fetchone()
                self.flag=0
                if self.var is not None and self.var[11] is not None:
            ...
            def issued(self):
                ...
                if self.n <= 3:
                   ...
                   if self.issuevar is not None and self.issuevar[11] is not None:
    ...
    def returnbook(self):
        class retu(main):
            def __init__(self):
                ...
                self.log = PhotoImage(file=r'E:\downloads\back.png')
                self.small_log = self.log.subsample(4, 4)  # Adjust the subsample factor as needed
                self.backbt = Button(self.f1, width=60, bg='#ffe8ec', activebackground='#ffe8ec', bd=0, relief='flat', command=self.cur)
                self.backbt.place(x=0, y=0)
                self.backbt.config(image=self.small_log, compound=LEFT)
            ...
            def retbook(self):
                ...
                if self.data!=None:
                    if self.data[11] is not None and int(self.data[11]) >= 1:
    ...
    def code(self):
            ...
            self.photo=PhotoImage(file=r"E:\downloads\Library-Management-System-master\Library-Management-System-master\image2.png")
